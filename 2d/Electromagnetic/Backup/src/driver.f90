...
ALLOCATE(rho(0:nx+1,0:ny+1), phi(0:nx+1,0:ny+1))
ALLOCATE(Ex(-1:nx+1,-1:ny+1), Ey(-1:nx+1,-1:ny+1),Bz(-1:nx+1,-1:ny+1))  ! -1 and nx+1 (ny+1) are ghost cells
ALLOCATE(Ex_grid(0:nx+1,0:ny+1), Ey_grid(0:nx+1,0:ny+1),Bz_grid(0:nx+1,0:ny+1))
ALLOCATE(Jx(-1:nx+1,-1:ny+1), Jy(-1:nx+1,-1:ny+1))
