...
INTEGER, PARAMETER :: N        = 500!4*nx*ny 		       ! max number of particles per species (needs to be a multiple of nx)
...
INTEGER, PARAMETER :: bndry = 1 ! 1: periodic (both x,y) , 2: open (i.e. radiation absorbing and particle outflow), 3:reflecting 
REAL*8, PARAMETER :: COUR = 0.1 ! time step courant number
...
REAL*8, PARAMETER :: u0x   = c*0.01d0    ! intial drift velocity
...
LOGICAL, PARAMETER :: randPos = .FALSE.  ! raddomizes particle positions
