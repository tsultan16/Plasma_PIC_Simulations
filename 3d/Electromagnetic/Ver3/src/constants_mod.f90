...
INTEGER, PARAMETER :: Np_max   = 1400000       	    ! max number of particles per species

INTEGER, PARAMETER :: maxsteps = 1000             ! max. number of time steps
...
REAL*8, PARAMETER :: m_i = 32.d0*m_e        ! charge to mass ratio - ions
