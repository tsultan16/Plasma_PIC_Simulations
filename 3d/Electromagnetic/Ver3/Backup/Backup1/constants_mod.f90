...
INTEGER, PARAMETER :: nx       = 100    	     ! mesh size 
INTEGER, PARAMETER :: ny       = 100
INTEGER, PARAMETER :: nz       = 100

INTEGER, PARAMETER :: ns       = 2     			 ! number of particle species
INTEGER, PARAMETER :: N        = 1    	         ! number of particles per species

INTEGER, PARAMETER :: maxsteps = 2000             ! max. number of time steps
...
REAL*8, PARAMETER :: ee = 1.d0         ! electron charge
...
REAL*8, PARAMETER  :: u0x   = 0.d0*c      ! intial drift velocity
REAL*8, PARAMETER  :: u0y   = 0.d0*c 
REAL*8, PARAMETER  :: u0z   = 0.0d0*c 
