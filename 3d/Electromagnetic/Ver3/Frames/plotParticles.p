...
do for [j=0:nt/tskip-1] {
  ...
  filename_e binary format="%*1int%double%double%*1int" using 1:2 with point pointtype 7 pointsize 0.15 lc rgb "red" title "ELECTRONS" ,\
  filename_i binary format="%*1int%double%double%*1int" using 1:2 with point pointtype 7 pointsize 0.25 lc rgb "blue" title "IONS" 
