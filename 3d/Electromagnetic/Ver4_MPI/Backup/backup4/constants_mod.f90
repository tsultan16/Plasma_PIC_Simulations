...
INTEGER, PARAMETER :: Np_max   = 20      	    ! max number of particles per species

INTEGER, PARAMETER :: maxsteps = 700             ! max. number of time steps
...
REAL*8, PARAMETER :: q_e  = -1.d0        ! electron charge
REAL*8, PARAMETER :: q_i  = -q_e        ! ion charge
REAL*8, PARAMETER :: m_e = 1.d8*q_i         ! charge to mass ratio - electrons
...
INTEGER, PARAMETER :: max_particles = Np_max/10 ! maximum number of particles allowed per MPI send
