...
INTEGER, PARAMETER :: nx       = 32    	     ! mesh size (use only powers of 2 to avoid malloc memory corruption) 
...
INTEGER, PARAMETER :: maxsteps = 3000            ! max. number of time steps
REAL*8, PARAMETER  :: COUR     = 0.5             ! time step courant number
INTEGER, PARAMETER :: tskip    = 3              ! file output frequency
...
REAL*8, PARAMETER :: q_e  = -1.d-3!-1.d-4        ! electron charge
