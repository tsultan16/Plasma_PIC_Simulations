...
INTEGER, PARAMETER :: nx       = 40    	     ! mesh size (use only powers of 2 to avoid malloc memory corruption) 
INTEGER, PARAMETER :: ny       = 80
INTEGER, PARAMETER :: nz       = 80
INTEGER, PARAMETER :: nb       = 3

INTEGER, PARAMETER :: ns       = 2     	  		 ! number of particle species
INTEGER, PARAMETER :: Np_max   = 1048576  	     ! max number of particles per species
...
INTEGER, PARAMETER :: N_filter = 4               ! how many times to repeat current filter (1 seems to be good enough for coarser grids)
...
REAL*8, PARAMETER  :: v0x   = 0.25d0/1.0     ! intial drift velocity
...
INTEGER, PARAMETER :: max_particles = Np_max/5 ! maximum number of particles allowed per MPI send
