...
INTEGER, PARAMETER :: Np_max   = 400000      	    ! max number of particles per species

INTEGER, PARAMETER :: maxsteps = 000             ! max. number of time steps
...
REAL*8, PARAMETER :: q_e  = -1.d-2        ! electron charge
REAL*8, PARAMETER :: q_i  = -q_e        ! ion charge
REAL*8, PARAMETER :: m_e = 1.d0!*q_i         ! charge to mass ratio - electrons
REAL*8, PARAMETER :: m_i = 32.d0*1.d0!*m_e        ! charge to mass ratio - ions
