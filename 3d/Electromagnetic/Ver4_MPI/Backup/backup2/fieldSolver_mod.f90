...
SUBROUTINE half_update_B()
    ...
    IF(bndry .EQ. 2) THEN
        ...
        !CALL radiation_b_xedge_prel()
        !CALL radiation_b_yedge_prel()
        !CALL radiation_b_zedge_prel()
...
SUBROUTINE full_update_EB()
    ...
    ELSE IF(bndry .EQ. 2) THEN
       ...
       !CALL radiation_b_xedge_post()
       !CALL radiation_b_yedge_post()
       !CALL radiation_b_zedge_post()
    ...
    IF(bndry .EQ. 2) THEN
        ...
        !CALL radiation_e_xedge_prel()
        !CALL radiation_e_yedge_prel()
        !CALL radiation_e_zedge_prel()
    ...
    ELSE IF(bndry .EQ. 2) THEN
       ...
       !CALL radiation_e_xedge_post()
       !CALL radiation_e_yedge_post()
       !CALL radiation_e_zedge_post()
