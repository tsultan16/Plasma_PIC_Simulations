...
INTEGER, PARAMETER :: nx       = 50    	     ! mesh size 
INTEGER, PARAMETER :: ny       = 50
INTEGER, PARAMETER :: nz       = 50
INTEGER, PARAMETER :: nb       = 3

INTEGER, PARAMETER :: ns       = 2     			! number of particle species
INTEGER, PARAMETER :: Np_max   = 1000      	    ! max number of particles per species

INTEGER, PARAMETER :: maxsteps = 150             ! max. number of time steps
