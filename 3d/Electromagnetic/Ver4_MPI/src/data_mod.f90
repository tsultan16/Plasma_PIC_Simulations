...
SUBROUTINE create_grid_arrays()
    ...
    total_grid_memory = SIZEOF(particles) + SIZEOF(bparticles_xp) + SIZEOF(bparticles_xp) + SIZEOF(particle_buffer_in) + &
                        SIZEOF(bparticles_yp) + SIZEOF(bparticles_yp) + &
                        SIZEOF(bparticles_tr) + SIZEOF(bparticles_br) + SIZEOF(bparticles_tl) + SIZEOF(bparticles_bl) + &
                        SIZEOF(rho) + SIZEOF(Ex) + SIZEOF(Ey) + SIZEOF(Ez) + SIZEOF(Bx) + SIZEOF(By) + SIZEOF(Bz)     + &
                        SIZEOF(Ex_grid) + SIZEOF(Ey_grid) + SIZEOF(Ez_grid) + SIZEOF(Bx_grid) + SIZEOF(By_grid)  + &
                        SIZEOF(Bz_grid) + SIZEOF(Jx) + SIZEOF(Jy) + SIZEOF(Jz) + SIZEOF(ne) + SIZEOF(ni) + SIZEOF(buffer) 
