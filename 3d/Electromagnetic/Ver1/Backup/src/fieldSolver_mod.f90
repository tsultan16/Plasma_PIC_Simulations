...
SUBROUTINE compute_fields()
    ...
    !************************************************
    ! Magnetic field half-update: B (t) -> B(t+dt/2) 
    !************************************************
    IF(bndry .EQ. 2) THEN
    ...
    !*********************************************
    ! Electric Field field update: E(t) -> E(t+dt)
    !*********************************************
    DO k = 0, nz+3
        DO j = 0, ny+3
            DO i = 0, nx+3
    ...
    !***************************************************************************
    ! Remaining magnetic field half-update:  B (t+dt/2) -> B(t+dt)
    !***************************************************************************
    DO k = -1, nz+2
        DO j = -1, ny+2
            DO i = -1, nx+2
