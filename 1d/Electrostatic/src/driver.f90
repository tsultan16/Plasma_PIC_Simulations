...
DEALLOCATE(rho, E, phi, ne, ni, particles,fv)
...
SUBROUTINE output()
	...
	dvv = (vmax-vmin)/vbins 
		DO i = 1, vbins
			WRITE(17,*) vmin+(i-0.5)*dvv, fv(1,i), fv(2,i)
		END DO
	END IF
