...
ESE_max = STATS_max 
  ...
  set xlabel "t"
  set ylabel "ESE"
  set yrange [0.9*ESE_min:1.1*ESE_max]
...
do for [j=0:nt/tskip-1] {
  ...
  plot "fv.txt" every ::i*vbins::vbins+(i*vbins)-1 using 1:2 with boxes fill solid 0.2 lc rgb "blue" title "Species 1+ Species2"
  unset title
  unset xlabel
  unset ylabel
  #unset yrange
